...
const HomePage = () => {
  ...
  const { chatClient, error, isLoading, connectionState } = useStreamChat();

  // Debug logging
  useEffect(() => {
    console.log("Stream Chat connection state:", connectionState);
    console.log("Chat client:", chatClient);
  }, [connectionState, chatClient]);
  ...
  if (isLoading || !chatClient || connectionState === 'connecting') return <PageLoader />;
  
  // Show connection error if Stream Chat is not connected
  if (connectionState === 'error' || connectionState === 'disconnected') {
    return (
      <div className="h-screen flex items-center justify-center">
        <div className="text-center">
          <p className="text-red-500 mb-4">Failed to connect to chat. Please refresh the page.</p>
          <button 
